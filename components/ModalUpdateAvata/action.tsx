...
import { uploadAvataAccount } from "@/service/imageService";
...
export type ActionUploadAvataState = {
...
export async function uploadAvata(
  _: ActionUploadAvataState,
  formData: FormData,
) {
  ...
  const rs = await uploadAvataAccount(image);
